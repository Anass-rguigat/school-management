...
<head>
    <meta charset="UTF-8">
    <title>404 Not Found - School Manager</title>
...
<body class="bg-light d-flex align-items-center justify-content-center" style="height: 100vh;">
    <div class="text-center p-5 bg-white shadow-sm rounded-4" style="max-width: 500px;">
        <i class="bi bi-search text-warning display-1 mb-4"></i>
        <h1 class="fw-bold">404 Not Found</h1>
        <p class="text-muted mb-4">Oops! The page you are looking for does not exist.</p>
